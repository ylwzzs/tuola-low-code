...
![](dec21ab2cdec72e5e2b2d9e4f00392c0.jpg)

2. 填写对应的连接器信息

![](76e0df236984005424b19385ac65a286.jpg)

3. 新建连接信息，要根据第三方提供的批量接口进行确定。

【协议】、【域名/IP地址】、【编码】需要第三方提供，其他配置项可以根据需要自行确定。

![](4e3cb115e85d8ef63437088f55f8eef6.jpg)
...
![](fde539096bd8d06407e2a68ae676647f.jpg)

（2）请求

根据第三方提供的接口信息进行配置

![](aca86dcca483dfbc29f50caf3ae603d4.jpg)
...
![](2b9163b79643a078f373c5182021e25f.jpg)

（4）成功失败

根据第三方提供的接口信息进行配置。需要第三方提供一个字段，用户确定接口整体调用情况（成功/失败）

![](e2cbef617375d82dc54caa9cd9256da1.jpg)

**配置动作流**

1. 新建动作流

![](0be0852664fc934f2bbeedf9942d255d.jpg)

2. 添加触发事件

（1）选择“自定义事件触发”

![](c0eb08eb8f5d55afea5a4ce6adcd7850.jpg)（2）选择“内置MQ监听”

![](bdb0137a92c41d2c694a152ddbccdb57.jpg)（3）填写“队列名称”，该名称可以自定义要保证全局唯一性。

![](02ae0f2cb49581ff6659bc2e1b3ca725.jpg)

注意：此处的队列名称与异构系统中的配置相同

![](9f59851bc599a41e0fe1f2d48c63a4ba.jpg)

（4）配置“接收参数”，此配置为固定配置参数名称不可变更。参数名称见下表

![](5e6763d5bcffc731eb3d831d7cb40567.jpg)
...
![](862bdded28c2d6acbab8db1020186f01.jpg)

（2）点击“输入参数配置”，“依据值”中选择“todoData”固定值

![](1d0c98e44a3a9fa6de0a2c09f408db16.jpg)

（3）匹配第三方接口入参字段

动态赋值选择【依据值下级】，并根据下拉框选择对应的参数

![](acf937cb31e07c7f13cda36a2fb1bcbf.jpg)

（4）配置“异常处理”，选择“跳过当前节点”

![](4e5c11dcf5141dc5efcde29ecf336a21.jpg)

![](fc9070aa728f8c4c2b0e637220a65f38.jpg)

4. 配置分支

（1）选择“分支”

![](68c8e016654d4dbfa94b43963c1beb0c.jpg)

（2）【执行方式】选择“排它分支”

![](a43e57cb7fe5316fdcfd06b3d50dcf0f.jpg)

（3）添加配置条件，第三方接口返回报文中需要提供一个字段，可以根据该字段的值进行判断接口是否调用成功。

![](c703de77d0152a76b6bd64e72b1e746c.jpg)
...
![](4c1966cd0e41d0a33230233b8cd50b5b.jpg)

（3）“条件1”表示接口调用成功的情况，其中“发送参数”需要配置。此处配置的**“参数名称”为固定值**不可更改。参数名称见下表

![](92ae04fb5e576607964fad1267cbab75.jpg)

![](56cc022114a2f8fff978d00ea5963b53.jpg)

注：tenantKey：当前租户识别码（以具体租户确定）

![](34f991e4250f5d0134b500542ab3fc22.jpg)

![](1123b417f1935f721627c196f4226230.jpg)
...
![](e08c3eeff6ec89f1d53aa058e0cf7f2f.jpg)

![](f4e9d856ac34da8408d31e3317e0bf59.jpg)

注：tenantKey：当前租户识别码（以具体租户确定）

![](24731d078016bceb7f14b7a7b18dd52e.jpg)

![](fd7802702585e8bb60b026cd5e9a89f6.jpg)
...
![](98fc919d0bf54d1db9fb19d84dc27ae3.jpg)